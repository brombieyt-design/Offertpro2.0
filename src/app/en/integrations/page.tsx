...
export const metadata: Metadata = {
  title: "Integrations – Offert Pro",
  description:
    "Connect Offert Pro to Fortnox, Visma, HubSpot, Stripe, BankID and 15+ other tools. Full REST API, webhooks and Zapier for custom workflows.",
  alternates: {
    canonical: `${SITE_URL}/en/integrations`,
    languages: {
  ...
  openGraph: {
    title: "Integrations – Offert Pro",
    description: "Connect Offert Pro to the stack you already use.",
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Offert Pro talks to the tools you already use — from accounting
            and CRM to payments, e-signatures and Zapier.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50/50">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-gray-500 mb-8">
            Tell us which — we prioritise the roadmap by real customer need.
          </p>
