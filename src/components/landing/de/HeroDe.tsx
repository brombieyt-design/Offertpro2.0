...
import { ArrowRight, Star, Shield, Users, Sparkles } from "lucide-react";
  ...
  return (
    <div className="relative w-full max-w-lg mx-auto aspect-square" aria-hidden="true">
        ...
        <div className="relative w-72 sm:w-80 animate-hero-float-1">
          <div className="bg-white rounded-2xl shadow-xl shadow-brand-500/10 border border-gray-100 p-5 sm:p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <span className="text-[10px] font-medium text-brand-600 bg-brand-50 px-2 py-0.5 rounded-full">ANGEBOT</span>
            </div>

            <div className="grid grid-cols-3 gap-2 mb-4">
              {[
                { label: "Versendet", value: "24", color: "text-brand-600" },
                { label: "Wert", value: "48k €", color: "text-emerald-600" },
                { label: "Quote", value: "68%", color: "text-amber-600" },
              ].map((s) => (
            ...
            <div className="space-y-2">
              {[
                { name: "Webdesign", amount: "4.500 €", color: "bg-green-400" },
                { name: "SEO-Paket", amount: "1.200 €", color: "bg-brand-400" },
                { name: "Texterstellung", amount: "1.500 €", color: "bg-amber-400" },
              ].map((line) => (
            ...
            <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between">
              ...
              <span className="text-base font-bold text-gray-900">7.200 €</span>
            </div>
          </div>
          ...
          <div className="absolute -top-4 -right-6 bg-white rounded-xl shadow-lg shadow-green-500/10 border border-green-100 px-3 py-2 animate-hero-float-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold text-green-700">Angebot angenommen!</span>
            </div>
          </div>
          ...
          <div className="absolute -bottom-3 -left-8 bg-white rounded-xl shadow-lg shadow-brand-500/10 border border-brand-100 px-3 py-2 animate-hero-float-1" style={{ animationDelay: "2s" }}>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold text-brand-700">Kunde hat geöffnet</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
        <circle cx="200" cy="200" r="170" fill="none" stroke="url(#orbit-gradient-de)" strokeWidth="1" strokeDasharray="6 6" className="animate-dash-move opacity-20" />
        <circle cx="200" cy="200" r="130" fill="none" stroke="url(#orbit-gradient-de)" strokeWidth="1" strokeDasharray="4 8" className="animate-dash-move opacity-15" style={{ animationDirection: "reverse" }} />
        <defs>
          <linearGradient id="orbit-gradient-de" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 border border-brand-100 mb-8 animate-fade-in-up">
              ...
              <span className="text-xs font-semibold text-brand-600 tracking-wide">
                Neue Version 2.0 — schneller als je zuvor
              </span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[3.75rem] xl:text-7xl font-bold tracking-tight text-gray-900 leading-[1.08] animate-fade-in-up">
              Mehr Aufträge mit{" "}
              <span className="gradient-text">beeindruckenden Angeboten</span>
            </h1>

            <p className="mt-6 text-lg text-gray-500 leading-relaxed animate-fade-in-up-delay-1 max-w-lg mx-auto lg:mx-0">
              Überzeugen Sie Kunden mit schönen Angeboten, verfolgen Sie Öffnungen
              in Echtzeit und gewinnen Sie Aufträge schneller. Alles auf einer
              Plattform — kostenlos starten.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-6 animate-fade-in-up-delay-3">
              ...
              <div className="flex items-center gap-1.5 text-xs text-gray-400">
                ...
                <span className="font-medium">500+ Unternehmen</span>
              </div>
              <div className="flex items-center gap-1.5 text-xs text-gray-400">
