...
const knowledge: { keywords: string[]; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Du kan skapa och spara mallar under **Dashboard → Mallar**. Inkludera standardrader, villkor och din branding. Nästa gång du skapar en offert väljer du bara din mall så fylls allt i automatiskt.",
  },
  {
    keywords: ["kund", "kunder", "kontakt", "kundregister"],
    answer:
      "Hantera dina kunder under **Dashboard → Kunder**. Lägg till företagsnamn, kontaktperson, e-post och organisationsnummer. Kundinfo fylls i automatiskt när du skapar nya offerter.",
  },
  {
...
function findAnswer(input: string): string {
  ...
  return bestMatch?.answer ?? fallbackAnswer;
}
