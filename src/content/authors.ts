...
export const authors: AuthorBio[] = [
  {
    ...
    roleDe: "Leitung Produktmarketing",
    bioEn:
    ...
    bioDe:
      "Emma leitet das Produktmarketing bei Offert Pro. Seit über einem Jahrzehnt hilft sie europäischen SaaS-Unternehmen dabei, technische Produkte in Geschichten zu übersetzen, mit denen Kleinunternehmerinnen und Kleinunternehmer tatsächlich arbeiten können — von frühen B2B-Startups in Stockholm bis hin zu Scale-ups in Berlin und Amsterdam.",
    expertise: [
      "Proposal writing",
  ...
  },
  {
    ...
    roleDe: "Leitung Customer Success",
    bioEn:
    ...
    bioDe:
      "Marcus leitet Customer Success bei Offert Pro. Bevor er zum Team kam, arbeitete er acht Jahre lang als selbstständiger Berater und Agenturinhaber und versendete mehrere tausend eigene Angebote — deshalb funktionieren unsere Vorlagen in der Praxis wirklich.",
    expertise: [
      "Invoicing workflows",
      "Pricing strategy",
      "Agency operations",
  ...
  },
  {
    ...
    bioDe:
      "Anna ist zugelassene EU-Juristin und berät Offert Pro in Fragen zu DSGVO, eIDAS-E-Signaturen und grenzüberschreitender Mehrwertsteuer. Zuvor war sie bei einer der größten nordischen Kanzleien im Bereich E-Signatur-Compliance tätig.",
    expertise: [
      "GDPR",
      "eIDAS e-signatures",
      "EU VAT law",
